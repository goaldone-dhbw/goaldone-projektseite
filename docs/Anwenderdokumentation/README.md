# Anwenderdokumentation GoalDone

Willkommen bei der Anwenderdokumentation für GoalDone. Diese Dokumentation hilft Ihnen dabei, die Funktionen der Plattform optimal zu nutzen.
...
- [Kalender und Planung](Features/Kalender-und-Planung.md)
